...
namespace DapperFantom.Services
{
    public class CategoryService
    {
        ...
        public List<Category> GetAllCategAdoNet()
        {
            ...
            // SQL query
            SqlCommand command = new SqlCommand("select * from Category", this._adoNetConnection);
        ...
        public List<Category> GetAllCategDapper()
        {
            ...
            try
            {
                categories = this._dapperConnection.Query<Category>(@"select * from Category").ToList();
            }
            catch (Exception ex)
            {
